...
* **Sistema de Gestão Escolar (Java):** Aplicação robusta com interface *drag and drop* e ligação completa à base de dados para operações de CRUD (adicionar, listar, atualizar e remover estudantes).
* **Sistema de Gestão de Estoques (Flutter/Dart/SQL):** Aplicação focada no controlo de stock de lojas.
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=vascomassingue80-ship-it&show_icons=true&theme=radical&include_all_commits=true&count_private=true" alt="GitHub Stats" />
</p>
